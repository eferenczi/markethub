...
export const api = {
  ...
  getFinancialReport: (marketId) => request(`/operations/financial-report${marketId ? `?market_id=${marketId}` : ""}`),
  ...
  getLayoutTemplates: (marketId) => request(`/operations/layout-templates?market_id=${marketId}`),
