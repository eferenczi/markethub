  ...
  return (
    <div className="flex flex-col gap-4">
      <section style={{ background: C.card, border: `1px solid ${C.line}` }} className="rounded-2xl p-4">
        <div className="flex items-start gap-3"><div className="flex-1"><p style={{ color: C.faint }} className="text-[10.5px] font-bold uppercase tracking-wide">Vendor application link</p><p style={{ color: C.sub }} className="text-[12px] mt-1">Share this with vendors. Required contact details, social handles, insurance, and product or booth photos are saved to your private CRM.</p></div><button onClick={load} title="Refresh applications" style={{ color: C.sub }} className="p-1"><RefreshCw size={16} /></button></div>
